...
class PopulationManager:
    ...
    def repopulateBest(self)->None:
        ...
        builder = self.parent.dataManager.getBuildersByRatingAgnostic()[0]
        #get their constants
...
class BuilderPool:
    def __init__(self, filepath:str="Optimizer_SingleTarget/", firstStartConst:list=None) -> None:
        if firstStartConst == None:
            raise Exception("Must provide firstStartConst")
